...
// Клавиатура – непрерывное управление на стрелочках блоком. Смена цвета блока по цветам радуги две клавиши переключают цвета вперед и назад.
// Проверка на стенки окна.
